...
<template>
  <BaseDialog :show="show" :title="modalTitle" width="full" @close="close">
    <div class="flex h-full min-h-0 flex-col">
      <!-- Filters -->
      <div class="mb-4 flex-shrink-0 border-b border-[color:var(--bx-border)] pb-4 ">
        <div class="grid grid-cols-8 gap-2">
          <div class="col-span-2 compact-select">
            <div class="relative group">
              ...
              <input
                v-model="q"
                type="text"
                class="w-full rounded-lg border-[color:var(--bx-border)] bg-gray-50/50 py-1.5 pl-9 pr-3 text-xs font-medium text-[color:var(--bx-text-soft)] transition-all focus:border-blue-500 focus:bg-[color:var(--bx-bg-elevated)] focus:ring-2 focus:ring-blue-500/10    dark:focus:bg-dark-800"
          ...
          <div class="flex items-center justify-end">
            <button type="button" class="rounded-lg bg-gray-100 px-3 py-1.5 text-xs font-semibold text-[color:var(--bx-text-soft)] transition-colors hover:bg-[color:var(--bx-bg-muted)]  dark:hover:bg-dark-600" @click="resetFilters">
              {{ t('common.reset') }}
            </button>
          </div>
        </div>
      ...
      <div class="flex min-h-0 flex-1 flex-col">
        <div class="mb-2 flex-shrink-0 text-xs text-[color:var(--bx-text-dim)]">
