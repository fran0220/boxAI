...
<template>
  <section class="card p-4 md:p-5">
    <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
      <h3 class="text-sm font-bold text-[color:var(--bx-text)]">
    ...
    <div v-if="loading" class="py-8 text-center text-sm text-[color:var(--bx-text-dim)]">
    ...
    <div v-else class="space-y-3">
      <div class="overflow-hidden rounded-xl border border-[color:var(--bx-border)]">
        <div class="max-h-[420px] overflow-auto">
          <table class="min-w-full text-left text-xs md:text-sm">
            <thead class="sticky top-0 z-10 bg-[color:var(--bx-bg-elevated)]">
            ...
            <tbody>
              <tr
                v-for="row in items"
                :key="row.model"
                class="border-b border-[color:var(--bx-border)] text-[color:var(--bx-text-soft)] last:border-b-0  "
              >
      ...
      <div v-if="viewMode === 'topn'" class="mt-3 text-xs text-[color:var(--bx-text-dim)]">
