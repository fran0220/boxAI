  ...
  <AppLayout>
            ...
            <div class="flex items-center gap-2 md:contents">
              ...
              <div class="relative" ref="filterDropdownRef">
                ...
                <div
                  ...
                  class="absolute right-0 top-full z-50 mt-1 w-48 rounded-lg border border-[color:var(--bx-border)] bg-[color:var(--bx-bg-elevated)] py-1 shadow-lg"
                >
                  <!-- Built-in filters -->
                  <button
                  ...
                  <div
                    ...
                    class="my-1 border-t border-[color:var(--bx-border)]"
                  ></div>
                ...
                >
                  <button
                    ...
                    :class="[
                      ...
                      isForcedVisibleColumn(col.key)
                        ? 'cursor-not-allowed text-[color:var(--bx-text-dim)]'
                        : 'text-[color:var(--bx-text-soft)] hover:bg-[color:var(--bx-hover)]  '
                    ]"
                  ...
                  >
                    ...
                    <Icon
                      ...
                      name="check"
                      size="sm"
                      :class="isForcedVisibleColumn(col.key) ? 'text-[color:var(--bx-text-dim)]' : 'text-primary-500'"
                      :stroke-width="2"
                    />
                  </button>
                </div>
        ...
        >
          <template #cell-email="{ value }">
            <div class="flex items-center gap-2">
              <div
                class="flex h-8 w-8 items-center justify-center rounded-full bg-primary-900/30"
              >
          ...
          <template #cell-notes="{ value }">
            <div class="max-w-xs">
              <span
                ...
                class="block truncate text-sm text-[color:var(--bx-text-muted)]"
              >
          ...
          >
            <div class="max-w-xs">
              <span
                class="block truncate text-sm text-[color:var(--bx-text-soft)]"
          ...
          <template #cell-groups="{ row }">
            <div v-if="allGroups.length > 0" class="flex flex-col gap-1">
              ...
              >
                ...
                <span class="text-[color:var(--bx-text-dim)]">{{ t('admin.users.exclusiveLabel') }}</span>
                ...
                <div
                  v-if="expandedGroupUserId === row.id"
                  class="absolute left-0 top-full z-50 mt-1.5 min-w-[160px] overflow-hidden rounded-lg border border-[color:var(--bx-border)] bg-[color:var(--bx-bg-elevated)] py-1 text-xs shadow-xl  "
                >
                  <div class="border-b border-[color:var(--bx-border)] px-3 py-1.5 text-[10px] font-medium uppercase tracking-wider text-gray-400  dark:text-dark-400">
              ...
              >
                <Icon name="globe" size="xs" class="h-3.5 w-3.5 text-[color:var(--bx-text-dim)]" />
                <span class="font-medium text-[color:var(--bx-text-muted)]">{{ getUserGroups(row).publicGroups.length }}</span>
                <span class="text-[color:var(--bx-text-dim)]">{{ t('admin.users.publicLabel') }}</span>
                <!-- Tooltip: 向下弹出 -->
          ...
          <template #cell-subscriptions="{ row }">
            ...
            <span
              v-else
              class="inline-flex items-center gap-1.5 rounded-md bg-[color:var(--bx-bg-muted)] px-2 py-1 text-xs text-gray-400  dark:text-dark-500"
            >
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              <div class="group relative">
                <button
                  class="font-medium text-[color:var(--bx-text)] underline decoration-dashed decoration-gray-300 underline-offset-4 transition-colors hover:text-primary-600  dark:decoration-dark-500 dark:hover:text-primary-400"
            ...
            <div class="flex items-center gap-1.5">
              ...
              <div class="usage-sort-trigger relative">
                ...
                <div
                  ...
                  class="absolute right-0 top-full z-50 mt-1 min-w-[120px] rounded-lg border border-[color:var(--bx-border)] bg-[color:var(--bx-bg-elevated)] py-1 shadow-lg"
                >
                  <button
                    v-for="metric in (['today', 'total'] as const)"
                    :key="metric"
                    type="button"
                    class="flex w-full items-center justify-between gap-3 px-3 py-1.5 text-left text-xs normal-case tracking-normal hover:bg-[color:var(--bx-hover)]"
                  ...
                  <div class="mt-1 border-t border-[color:var(--bx-border)] px-3 py-1 text-[10px] normal-case tracking-normal text-gray-400  dark:text-dark-500">
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="action-menu-trigger flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-[color:var(--bx-hover)] hover:text-gray-900  dark:hover:text-white"
                :class="{ 'bg-[color:var(--bx-bg-muted)] text-[color:var(--bx-text)]  ': activeMenuId === row.id }"
              >
    ...
    <Teleport to="body">
      <div
        ...
        class="action-menu-content fixed z-[9999] w-48 overflow-hidden rounded-xl bg-[color:var(--bx-bg-elevated)] shadow-lg ring-1 ring-black/5 dark:ring-white/10"
          ...
          <template v-for="user in users" :key="user.id">
            <template v-if="user.id === activeMenuId">
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-[color:var(--bx-text-soft)] hover:bg-[color:var(--bx-hover)]  "
              >
              ...
              <div class="my-1 border-t border-[color:var(--bx-border)]"></div>
