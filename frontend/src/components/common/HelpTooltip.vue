  ...
  >
    ...
    <Teleport to="body">
      <div
        ...
        role="tooltip"
        :class="[
          'fixed z-[99999] -translate-x-1/2 -translate-y-full rounded-lg bg-gray-900 p-3 text-xs leading-relaxed text-white shadow-xl ring-1 ring-white/10 dark:bg-[color:var(--bx-bg-elevated)]',
          props.widthClass,
        ]"
      ...
      >
        ...
        <slot>{{ content }}</slot>
        <div class="absolute -bottom-1 left-1/2 h-2 w-2 -translate-x-1/2 rotate-45 bg-gray-900 dark:bg-[color:var(--bx-bg-elevated)]"></div>
      </div>
    </Teleport>
  </div>
</template>
