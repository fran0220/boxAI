    ...
    <div class="grid grid-cols-2 gap-3 sm:flex">
      <button
        ...
        :class="[
          ...
          !method.available
            ? 'cursor-not-allowed border-[color:var(--bx-border)] bg-[color:var(--bx-bg-muted)] opacity-50  '
            : selected === method.type
              ? methodSelectedClass(method.type)
              : 'border-[color:var(--bx-border)] bg-[color:var(--bx-bg-elevated)] text-[color:var(--bx-text-soft)] hover:border-gray-400    dark:hover:border-dark-500',
        ]"
        ...
        <span class="flex items-center gap-2">
          ...
          <span class="flex flex-col items-start leading-none">
            ...
            <span
              ...
              class="text-[10px] tracking-wide text-[color:var(--bx-text-dim)]"
            >
