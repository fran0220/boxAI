  ...
  <div v-if="visible" class="space-y-1">
    ...
    <div v-if="primaryResetCreditExpiry" class="space-y-1">
      <div class="flex flex-wrap items-center gap-1">
        <span
          class="inline-flex max-w-full items-center rounded bg-gray-100 px-1.5 py-0.5 text-[10px] leading-4 text-[color:var(--bx-text-muted)] tabular-nums dark:bg-[color:var(--bx-bg-elevated)] "
        ...
        <button
          ...
          class="inline-flex items-center rounded-full bg-gray-100 px-1.5 py-0.5 text-[10px] font-medium leading-4 text-[color:var(--bx-text-muted)] transition-colors hover:bg-gray-200 dark:bg-[color:var(--bx-bg-elevated)]  dark:hover:bg-gray-700"
      ...
      <div
        ...
        class="inline-grid max-w-full gap-0.5 rounded border border-gray-200 bg-white px-1.5 py-1 text-[10px] leading-4 text-[color:var(--bx-text-muted)] shadow-sm dark:border-[color:var(--bx-border)] dark:bg-[color:var(--bx-bg-elevated)] "
      >
        ...
        >
          <span class="h-1 w-1 shrink-0 rounded-full bg-[color:var(--bx-text-dim)]" />
