<template>
  <div>
    ...
    <div v-if="props.loading && !props.stats" class="space-y-0.5">
      ...
      <div class="h-3 w-16 animate-pulse rounded bg-[color:var(--bx-bg-muted)]"></div>
    ...
    <div v-else-if="props.stats" class="space-y-0.5 text-xs">
      ...
      <div class="flex items-center gap-1">
        ...
        >
        <span class="font-medium text-[color:var(--bx-text-soft)]">{{
      ...
      <!-- Cost (Account) -->
      <div class="flex items-center gap-1">
        <span class="text-[color:var(--bx-text-dim)]">{{ t('usage.accountBilled') }}:</span>
      ...
      <div v-if="props.stats.user_cost != null" class="flex items-center gap-1">
        <span class="text-[color:var(--bx-text-dim)]">{{ t('usage.userBilled') }}:</span>
        <span class="font-medium text-[color:var(--bx-text-soft)]">{{
