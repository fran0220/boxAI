<template>
  ...
  >
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          >
            ...
            <p class="text-2xl font-bold text-[color:var(--bx-text)]">
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-[color:var(--bx-text-dim)]">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-[color:var(--bx-text)]"
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-[color:var(--bx-text-dim)]">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-[color:var(--bx-text)]"
      ...
      <div
        v-else-if="!loading"
        class="flex flex-col items-center justify-center py-12 text-[color:var(--bx-text-dim)]"
      >
