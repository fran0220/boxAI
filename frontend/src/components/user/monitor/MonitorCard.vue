  ...
  >
    ...
    <div class="flex items-start gap-3">
      ...
      <div class="flex-1 min-w-0">
        <div class="text-base font-semibold truncate text-[color:var(--bx-text)]">
          {{ item.name }}
        </div>
        <div class="mt-0.5 flex items-center gap-1.5 min-w-0">
          ...
          <span class="font-mono text-xs truncate text-[color:var(--bx-text-dim)]">
            {{ item.primary_model }}
          </span>
          <span
    ...
    <!-- Divider -->
    <div class="mt-4 border-t border-[color:var(--bx-border)]"></div>
