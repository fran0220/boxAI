  ...
  <div class="fixed inset-0 z-50 overflow-y-auto" @click.self="$emit('close')">
    <div class="flex min-h-full items-center justify-center p-4">
      ...
      <div class="relative w-full max-w-md transform rounded-xl bg-[color:var(--bx-bg-elevated)] p-6 shadow-xl transition-all ">
        <!-- Header -->
        <div class="mb-6">
          <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-red-900/30">
          ...
          <h3 class="mt-4 text-center text-xl font-semibold text-[color:var(--bx-text)]">
            {{ t('profile.totp.disableTitle') }}
          </h3>
          <p class="mt-2 text-center text-sm text-[color:var(--bx-text-dim)]">
