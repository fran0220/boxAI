  ...
  <div class="relative inline-block">
    <span
      ...
      :class="[
        ...
        effectivePlatform
          ...
          : 'border-[color:var(--bx-border)] bg-[color:var(--bx-bg-muted)] text-[color:var(--bx-text-soft)]   ',
      ]"
      @mouseenter="onEnter"
      @mouseleave="onLeave"
      @focusin="onEnter"
    ...
    >
      ...
      <span
        ...
        class="rounded bg-gray-200/60 px-1 text-[10px] uppercase text-[color:var(--bx-text-muted)] dark:bg-dark-700 "
      >
        {{ model.platform }}
      </span>
      {{ model.name }}
    ...
    <Teleport to="body">
      <div
        ...
        ref="popoverEl"
        role="tooltip"
        class="pointer-events-none fixed z-[99999] w-80 max-w-[min(22rem,calc(100vw-1rem))] rounded-lg border bg-[color:var(--bx-bg-elevated)] text-xs shadow-xl "
      ...
      >
        ...
        >
          ...
          <span
            v-if="model.platform"
            class="flex-shrink-0 rounded bg-[color:var(--bx-bg-elevated)] px-1.5 py-0.5 text-[10px] uppercase tracking-wide "
          >
            {{ model.platform }}
          </span>
        </div>
        ...
        <div class="p-3">
          <div v-if="!model.pricing" class="text-[color:var(--bx-text-dim)]">
            {{ noPricingLabel }}
          </div>

          <div v-else class="space-y-2 text-[color:var(--bx-text-soft)]">
            <div class="flex justify-between">
              <span class="text-[color:var(--bx-text-dim)]">{{ t(prefixKey('billingMode')) }}</span>
            ...
            <div
              ...
              :class="[popoverBorderClass]"
            >
              <div class="mb-1 font-medium text-[color:var(--bx-text-muted)]">
...
const popoverHeaderClass = computed(() =>
  effectivePlatform.value
    ...
    : 'bg-[color:var(--bx-bg-muted)] text-[color:var(--bx-text-soft)]  ',
)
