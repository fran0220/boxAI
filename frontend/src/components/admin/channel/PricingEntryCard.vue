<template>
  <div class="rounded-lg border border-[color:var(--bx-border)] bg-[color:var(--bx-bg-muted)] p-3  ">
    ...
    >
      ...
      <div v-else class="flex-1 text-xs font-medium text-[color:var(--bx-text-dim)]">
    ...
    >
      <div class="collapsible-inner">
        ...
        <div class="mt-3 flex items-start gap-2">
          <div class="flex-1">
            <label class="text-xs font-medium text-[color:var(--bx-text-dim)]">
        ...
        <div v-if="entry.billing_mode === 'token'">
          ...
          <label class="mt-3 block text-xs font-medium text-[color:var(--bx-text-dim)]">
        ...
        <div v-else-if="entry.billing_mode === 'per_request'">
          ...
          <div v-else class="mt-2 rounded border border-dashed border-[color:var(--bx-border)] p-3 text-center text-xs text-gray-400 ">
