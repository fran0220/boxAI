  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="space-y-1.5">
        ...
        <button
          type="button"
          class="inline-flex items-center gap-1 rounded border border-dashed border-[color:var(--bx-border)] px-2 py-1 text-xs text-[color:var(--bx-text-dim)] hover:border-primary-400 hover:text-primary-600   dark:hover:border-primary-500 dark:hover:text-primary-400"
          @click="addRow"
        >
...
function bodyModeButtonClass(mode: BodyOverrideMode): string {
  ...
  return 'border-[color:var(--bx-border)] bg-[color:var(--bx-bg-elevated)] text-[color:var(--bx-text-muted)] hover:border-primary-300   '
}
