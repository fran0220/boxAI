...
export default function InputParamsPanel({
  ...
  return (
    <div className={`grid ${cols} gap-2 text-xs flex-1`}>
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{pg.size}</span>
        <button
          type="button"
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{pg.quality}</span>
        <Select
        ...
        <ButtonTooltip
          ...
          text={isFalProvider ? pg.falNoAutoQuality : pg.codexNoQuality}
        />
      </label>
      <label className="flex flex-col gap-0.5">
        <span className="text-gray-400 dark:text-gray-500 ml-1">{pg.format}</span>
        <Select
      ...
      {showTransparentOutputControl ? (
        ...
        >
          <span className="text-gray-400 dark:text-gray-500 ml-1">{pg.transparentBg}</span>
          <Select
        ...
        >
          <span className="text-gray-400 dark:text-gray-500 ml-1">{pg.compression}</span>
          <input
          ...
          <ButtonTooltip
            ...
            text={isFalProvider ? pg.falNoCompression : pg.compressionJpegWebpOnly}
          />
        </label>
      )}
      <label
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{pg.moderation}</span>
        <Select
      ...
      >
        <span className="text-gray-400 dark:text-gray-500 ml-1">{pg.count}</span>
        <input
          value={nInput}
        ...
        <ButtonTooltip visible={streamConcurrentByN && streamConcurrentHint.visible && !nLimitHint.visible} text={pg.nConcurrentHint} />
      </label>
    </div>
  )
}
