...
export default function SupportPromptModal() {
  ...
  return createPortal(
    ...
    >
      ...
      <div
        role="dialog"
        aria-label={pg.supportPrompt}
        className="relative z-10 w-full max-w-sm rounded-[2rem] border border-white/50 bg-white/95 p-6 pb-7 shadow-2xl ring-1 ring-black/5 animate-modal-in dark:border-white/[0.08] dark:bg-[var(--bx-bg-elevated)]/95 dark:ring-white/10 flex flex-col"
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            ...
            onClick={dismissSupportPrompt}
            className="flex w-full sm:w-auto flex-1 items-center justify-center gap-2 rounded-[var(--bx-radius-lg)] bg-[#946ce6] px-5 py-3.5 text-[15px] font-semibold text-white transition-all hover:bg-[#8358dc] active:scale-[0.98] dark:bg-[#946ce6] dark:hover:bg-[#a885ee]"
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={dismissSupportPrompt}
            className="flex w-full sm:w-auto flex-1 items-center justify-center gap-2 rounded-[var(--bx-radius-lg)] bg-[#f4f4f5] px-5 py-3.5 text-[15px] font-semibold text-gray-600 transition-all hover:bg-gray-200 active:scale-[0.98] dark:bg-[#27272a] dark:text-gray-300 dark:hover:bg-[#3f3f46]"
          >
