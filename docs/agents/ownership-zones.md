...
| `docs/WEB_PLATFORM.md` | product-first | Dual-frontend / SSO / deploy topology | no conflict expected |
| `deploy/Caddyfile.you-box.com` | product-first | Production 3-host Caddy for you-box.com | no conflict expected |
