      ...
      return okResult({
        ...
        text: hosts.length
          ? [
              ...
              "credential=saved means BoxAI already has the configured SSH credential; use create_session directly and do not ask the user for that password/key.",
