...
export const ORGANIZER_SYSTEM_PROMPT = `# BoxAI Memory Organizer

You are running an offline memory organization pass for BoxAI.
...
export const TOPIC_CLUSTER_SYSTEM_PROMPT = `You are grouping existing BoxAI memories for an offline organization pass.
