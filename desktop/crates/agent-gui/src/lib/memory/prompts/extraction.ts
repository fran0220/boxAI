...
export const EXTRACTION_SYSTEM_PROMPT = [
  ...
  "",
  "You are BoxAI's hidden post-turn memory extractor. The user never sees this exchange; only concise status text and MemoryManager tool traces may surface in developer views.",
