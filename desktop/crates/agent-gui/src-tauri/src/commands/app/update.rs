...
const DEFAULT_UPDATE_REPOSITORY: &str = "fran0220/boxAI";
...
async fn manifest_exists(client: &reqwest::Client, manifest_url: &str) -> Result<bool, String> {
    let response = client
        .head(manifest_url)
        .header(USER_AGENT, "BoxAI-Updater")
        .send()
        .await
...
mod tests {
    ...
    fn feed_entry(tag_name: &str) -> ReleaseFeedEntry {
        ReleaseFeedEntry {
            ...
            title: Some(format!("BoxAI {tag_name}")),
            html_url: Some(format!(
                "https://github.com/fran0220/boxAI/releases/tag/{tag_name}"
            )),
...
<feed xmlns="http://www.w3.org/2005/Atom">
  <entry>
    ...
    <link rel="alternate" type="text/html" href="https://github.com/fran0220/boxAI/releases/tag/v0.1.2"/>
    <title>BoxAI v0.1.2</title>
  </entry>
</feed>"#,
        )
        ...
        assert_eq!(
            ...
            vec![ReleaseFeedEntry {
                ...
                title: Some("BoxAI v0.1.2".to_string()),
                html_url: Some(
                    "https://github.com/fran0220/boxAI/releases/tag/v0.1.2".to_string()
                ),
    ...
    fn prerelease_channel_can_select_prerelease_manifest() {
        ...
        assert_eq!(
            ...
            "https://github.com/fran0220/boxAI/releases/download/v0.1.2-beta.1/latest.json"
        );
